  ...
  return (
    <section className="container mx-auto mb-15">
      <div className="bg-primary rounded-[10px]  px-6 md:px-12 pt-[68px] pb-[94px] flex flex-col items-center text-center relative">
        <h2 className="text-2xl md:text-[34px] max-w-[840px] lg:text-[40px] font-semibold mb-8  lg:leading-[50px] lg:mb-[55px]">
          {title}
        </h2>
        <form
          ...
          method="post"
          target="_blank"
          className="bg-secondary w-full max-w-2xl relative h-[56px] lg:h-[64px] flex items-center rounded-[1000px] border-2 border-black px-8"
        >
          <input
            type="email"
            name="email"
