...
//   size = 'md'
  ...
  const baseStyles = "px-[35px] h-[64px] flex items-center justify-center md:text-[20px] leading-[34.07px] rounded-[751.58px] transition-all duration-700 text-center w-fit";
  
  const variants = {
    primary: "bg-primary text-black hover:bg-primary/60",
    secondary: "bg-secondary! text-black hover:bg-secondary/40",
    outline: "border border-black/10 bg-white/20 backdrop-blur-sm text-black hover:bg-white/30",
